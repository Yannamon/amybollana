...
<body>
    ...
    <section class="learn-section" id="learn-more">
        <!-- Hero Banner -->
        <div class="learn-hero-banner">
            <h2>Learn More</h2>
            <p>
                Learning calligraphy is really quite simple. In less than two hours, I will give you the tools to learn
                calligraphy and start a creative, mindful practice.
            </p>
    ...
    <section class="testimonials">
        ...
        <div class="whats-included">
            ...
            <div class="bonus-section">
                <div>
                    <h3>Bonus</h3>
                    <h6>Learn to draw simple botanical illustrations to make beautiful homemade cards</h6>
                </div>
                <div>
                    <h3>Plus</h3>
